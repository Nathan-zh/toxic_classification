...
def Attention(inputs):
    ...
    w_omega = tf.get_variable("W", shape=[inputs_dim, attention_size], initializer=tf.random_normal_initializer) # input_dim*output_dim
    b_omega = tf.get_variable("b", shape=[attention_size], initializer=tf.random_normal_initializer) # output_dim
    u_omega = tf.get_variable("u", shape=[attention_size], initializer=tf.random_normal_initializer) # output_dim
